"""
Evaluation utilities for Dataset 2 Mamba model.
"""
...
def evaluate_mamba(
    ...
    """
    Evaluate Mamba model on a DataLoader.
...
def evaluate_and_report(
    ...
    """
    Evaluate Mamba model and print formatted classification report.
    """
    y_true, y_pred, y_prob = evaluate_mamba(model, dataloader, device)
    metrics = compute_all_metrics(y_true, y_pred, y_prob)

    print(f"\n--- Mamba Classification Report ({label}) ---")
